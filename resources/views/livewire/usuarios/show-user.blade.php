                    ...
                    <table class="min-w-full  border-collapse block md:table">
                        ...
                        <tbody class="block md:table-row-group">
                            @foreach ($usuarios as $user)
                                <tr class="bg-gray-100 border-2 hover:bg-gray-300 border-gray-500 rounded-lg m-2 md:border-none block md:table-row"
                                    ...
                                    <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                                            class="inline-block w-1/3 md:hidden font-bold">Nombre:</span>{{ $user->name }}
                                    </td>
                                    <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                                    ...
                                    <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                                        ...
                                        <div class="flex justify-center gap-4">
                                            ...
                                            <button
                                                class="btn-sm border-2 border-black bg-indigo-400 rounded-lg text-slate-700 hover:bg-indigo-500 hover:text-black"
                    ...
                    <x-dialog-modal>
                            ...
                            <div class="px-4 ">
                                ...
                                <div class="flex items-center">
                                    <div class="m-3">
                                        ...
                                        @if ($foto)
                                            <img class="h-24 w-24 rounded-full" src="{{ $foto->temporaryUrl() }}"
                                                alt="">
                                        ...
                                        @else
                                            <span class="btn-sm bg-indigo-500 rounded-lg text-slate-700">
                                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                                    x="0" y="0" width="40" height="40" viewBox="0 0 134 134"
                                                    xml:space="preserve">
                                    ...
                                    <x-input type="file" class="w-full" id="{{ $identificador }}"
                                        wire:model="foto" />
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-input type="number" class="w-full" wire:model="usuario.celular" />
                        ...
                        <x-slot name="footer">
                            <div class="mr-4">
                                ...
                                <button class="h-full rounded-md bg-indigo-500 hover:bg-indigo-600 text-white p-2"
                                    wire:loading.attr="disabled" wire:target="update,foto" wire:click="update">
                                    <svg wire:loading wire:target="update,foto"
                                        class="animate-spin w-4 h-4 fill-current shrink-0" viewBox="0 0 16 16">
                                        <path
                                            d="M8 16a7.928 7.928 0 01-3.428-.77l.857-1.807A6.006 6.006 0 0014 8c0-3.309-2.691-6-6-6a6.006 6.006 0 00-5.422 8.572l-1.806.859A7.929 7.929 0 010 8c0-4.411 3.589-8 8-8s8 3.589 8 8-3.589 8-8 8z">
                                        </path>
                                    </svg>
                                    <span class="ml-2" wire:loading.remove
                                        wire:target="update,foto">Actualizar</span>
